...
func launchBreakdownReportsInteractivity() {
    ...
    #expect(line.contains("composerCaretMs="))
    ...
    #expect(line.contains("firstContentFrameMs="))
    #expect(line.contains("orderFrontToContentMs="))
    #expect(line.contains("contentReadyMs="))
    #expect(line.contains("followUpStoreAttachedMs="))
}
